    ...
    <div class="min-h-screen py-8 px-4">
        <div class="max-w-7xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-[#9ca3af] mt-2">Lengkapi form di bawah untuk menambahkan data peserta magang</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                        ...
                        <div>
                            <div class="mb-6">
                                ...
                                <img id="preview"
                                    style="max-width: 200px; border-radius: 12px; margin-top: 1rem; display: none;"
                                    alt="Preview">
                                @error('foto')
                                    <p class="text-red-400 text-xs mt-2">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="border-t border-[#3a3a3a] pt-6 mt-8 mb-6 md:border-t-0 md:pt-0 md:mt-0">
                                <h3 class="text-white text-lg font-semibold mb-4">
                                    <i class="fas fa-share-alt mr-2"></i>Media Sosial (Boleh Di Kosongkan)
                                </h3>
